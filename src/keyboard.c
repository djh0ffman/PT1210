...
static input_binding_t bindings_dj[] =
{
	...
	{ KEYCODE_BACKSPACE,	KEYCODE_NONE,	PRESS_TYPE_ONESHOT,			pt1210_action_toggle_repitch_lock		},
	{ KEYCODE_DELETE,		KEYCODE_NONE,	PRESS_TYPE_ONESHOT,			pt1210_action_pitch_reset				},
